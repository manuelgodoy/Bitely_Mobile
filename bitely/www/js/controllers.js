...
.controller('AppCtrl', 
    ...
    $scope.fakebook = function(from){
    	...
    	Login.save({access_token:"CAAT3dgau4T4BAPcqEex4QNh6hDVfR5UKelXNBIZCbVGugOIqvnwAHRZCaZCY8mA1ZCQ6kYUum7D0ZC3bEQMUB82WY2ynZAeWktVb61m1ANTXQDeI7tHVSbLfzZCdFGsGYxKH9JPpqeShLv6WvneCaNSIuwSfIxAW8m8SQfidLbyivN49vBj19W2LAiJzP4j5UZCrAkSTPYYNWawMoR1wTDZC5BnnRS0USSQEZD"}
		).$promise.then(function(res){
    		// console.log(res);
    		if (res.user!==null){
